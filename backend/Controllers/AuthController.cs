    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterDto model)
        {
            try
            {
                ...
                if (model.RegisterAsManager && string.IsNullOrWhiteSpace(model.CompanyName))
                    return BadRequest(new { message = "Укажите название компании" });

                var role = model.RegisterAsManager ? UserRole.OfficeManager : UserRole.Client;
